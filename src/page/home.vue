...
<script>
	...
	import {userCount, orderCount, getUserCount, getOrderCount, adminDayCount, adminCount,getdata} from '@/api/getData'
    export default {
    	data(){
    		return {
    			userCount: null,
    	...
    	methods: {
    		async initData(){
                ...
                this.userCount=res.data.newUser;
                this.orderCount=res.data.newOrder;
                this.adminCount=res.data.newAdmin;
                this.allUserCount=res.data.userCount;
                this.allOrderCount=res.data.orderCount;
                this.allAdminCount=res.data.adminCount;
    		},
