  ...
  <div class="fillcontain">
    ...
    <div class="table_container">
      <el-table :data="tableData" highlight-current-row style="width: 100%">
        ...
        <el-table-column property="phone" label="手机号" width="220">
        </el-table-column>

        <el-table-column property="createTime" label="注册日期" width="220">
        </el-table-column>
        <el-table-column property="money" label="金额" width="220">
        </el-table-column>
